    ...
    return (
        <StyledWrapper>
            <ul className="wrapper">
                <a href={"https://www.facebook.com/?locale=ru_RU"} target={"_blank"} style={{color:'black',textDecoration:'none'}}>
                ...
                <a href={"https://www.instagram.com/"} target={"_blank"} style={{color:'black',textDecoration:'none'}}>
